...
<div class="form-group">
    <div class="col-md-3 col-sm-12{{ $errors->has('aba') ? ' has-error' : '' }}">
        ...
        {!! Form::number('aba', null, ['class'=>'form-control', 'required']) !!}
    </div>
